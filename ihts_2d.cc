...
//#include "PipeSystem.h"
  ...
  //  number_of_surface_heat_and_mass_fluxes(11)
  {
	  ...
	  const std::string input_filename = "input.prm";
...
//	  preheating_input_filename+=thermal_conductivity_factor_str;
	  ...
	  //
	  //    previous_new_soil_avg_surface_temperature=0.;
	  //    previous_new_road_avg_surface_temperature=0.;
	  //    previous_new_soil_max_surface_temperature=0.;
	  //    previous_new_soil_min_surface_temperature=0.;
	  //    previous_new_road_max_surface_temperature=0.;
	  //    previous_new_road_min_surface_temperature=0.;
	  //
	  ...
	  //
	  //    inlet_collector_temperature=0.;
	  //    inlet_storage_temperature=0.;
  }
